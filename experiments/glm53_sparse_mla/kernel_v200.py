"""Iteration 200: 64-register donor roles with 192-register compute roles; based on v194.
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # compute registers. Final budget is 256*64 + 256*192 = 65536.
        # Require an actual initial allocation of 128 registers/thread before launch.
        if warp >= 8:
