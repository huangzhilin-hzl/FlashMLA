"""Iteration 096: fetch current tile indices before waiting for its shared stage; based on091; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v096 requires --block-k 128"
