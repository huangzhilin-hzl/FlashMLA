"""Iteration 097: combine pre-wait index fetching with four producer warps; based on096/094; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v097 requires --block-k 128"
