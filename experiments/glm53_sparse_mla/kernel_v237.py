"""Iteration237: producer unroll2 with80/176 role registers.

Based onv236,raise donor/producer allocation from64 to80 while keeping
compute176. This uses the existing65536-register CTA pool to investigate
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # Initial128*512=65536; final256*80+256*176=65536 registers.
        if warp >= 8:
