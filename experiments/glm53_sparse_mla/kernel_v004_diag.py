"""Iteration 004: persist online output in TMEM, release the allocation permit early.
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        print("TMEM score", ts.layout, "TMEM output", to.layout)
        ...
        print("S tiled copy", scopy, "O tiled copy", ocopy)
