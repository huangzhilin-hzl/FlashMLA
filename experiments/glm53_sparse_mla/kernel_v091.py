"""Iteration 091: combine validity bitmaps with early post-PV stage release; based on090/089; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v091 requires --block-k 128"
