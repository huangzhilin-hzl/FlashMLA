"""Iteration 156: alternate independent PV accumulators between high and residual terms; based on v152.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v156 requires --block-k 128"
