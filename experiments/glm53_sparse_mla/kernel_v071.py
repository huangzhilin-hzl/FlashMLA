"""Iteration 071: M32 head groups and B-collector reuse; based on054; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v071 requires --block-k 128"
