"""Iteration 202: output evict-first on the validated 64/176 high-precision path; based on v197.
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # Inspect the actual initial register allocation before launch.
        if warp >= 8:
