"""Compile-time audit of v059 N256 four-group Layout-E copies and staged-output mapping."""
import cutlass
...
logical = [(tid % 64, (tid // 64) * 128 + group * 32 + j)
           for group in range(4) for tid in range(128) for j in range(32)]
