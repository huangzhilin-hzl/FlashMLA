"""Iteration 214: loop four main TMA requests to reuse coordinate arguments; based on v197.
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # Inspect initial allocation before launch; qualified with CuTeDSL 4.6.2.
        if warp >= 8:
