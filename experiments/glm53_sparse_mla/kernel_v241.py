"""Iteration241: unroll2 with producer104, issuer64 and compute168.

Based on v240, give the complete issuer/idle warpgroup 64 registers and
both compute warpgroups 168, retaining producer104 and role-local
allocation. The total remains 65536 registers. This tests eliminating
issuer UR/R transfers without reintroducing local-memory spills.
"""
import math
import os
import torch
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # Initial 128*512 = 65536; final 256*168 + 128*104 + 128*64 = 65536.
