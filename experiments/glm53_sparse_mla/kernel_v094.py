"""Iteration 094: four producer warps with unchanged eight compute warps; based on091; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v094 requires --block-k 128"
