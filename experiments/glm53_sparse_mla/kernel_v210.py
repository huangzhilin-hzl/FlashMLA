"""Iteration 210: keep half-tree sums in separate packed lanes; based on v197.
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # Verified parent compiles on CuTeDSL 4.6.2; inspect initial allocation before launch.
        if warp >= 8:
