"""Iteration 090: publish per-warp validity bitmaps to replace repeated index loads; based on086; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v090 requires --block-k 128"
