"""Iteration 101: 64-column correction TMEM transfers with four producer warps; based on097; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v101 requires --block-k 128"
