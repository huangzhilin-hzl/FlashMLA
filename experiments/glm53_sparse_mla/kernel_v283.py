"""Iteration 283: donor80/compute176 register allocation; based on v281.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v283 requires --block-k 128"
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # compute registers. Final budget is 256*80 + 256*176 = 65536.
