"""Iteration228: normal-M64 dual-plane TMEM reuse with64-key stages.
...
Based on v227; explicitly elect one normal-MMA issuer for each QK/PV group.
Keep all math, layout, TMEM ownership and synchronization unchanged.
"""
import math
import os
import torch
...
class SparseMLA:
    def __init__(self, block_k=64):
        assert block_k == 64, "v228 requires --block-k 64"
