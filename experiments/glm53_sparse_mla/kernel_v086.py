"""Iteration 086: reduce raw QK maxima and fuse score scaling into exp2 inputs; based on085; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v086 requires --block-k 128"
