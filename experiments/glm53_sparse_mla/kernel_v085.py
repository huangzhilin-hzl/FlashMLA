"""Iteration 085: fold scale448 into exp2 on the baseline-precision path; based on054/075; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v085 requires --block-k 128"
