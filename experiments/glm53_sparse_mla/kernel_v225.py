"""Iteration 225: publish vector-copy stages after producer completion; based on v223.
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        if (warp >= 8) & (warp < 12):
            ...
            for block in cutlass.range(cute.ceil_div(nvalid, self.block_k)):
                ...
                # The producer barrier joins all per-thread copy completion.
                # One release arrival publishes both copied KV and bitmaps.
                cute.arch.barrier(barrier_id=2, number_of_threads=128)
                if load_tid == 0:
