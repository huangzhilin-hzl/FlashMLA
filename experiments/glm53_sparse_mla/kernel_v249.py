"""Iteration249: acquire compute metadata through QK completion.

Based on v247, remove the compute role's duplicate full-stage wait.
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        if (warp >= 8) & (warp < 12):
            ...
            for block in cutlass.range(num_blocks):
                ...
                # Retain the original trailing fence; hardware commit publishes KV reuse.
                tmem_before_sync()
