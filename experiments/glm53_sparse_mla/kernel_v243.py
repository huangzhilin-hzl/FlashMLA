"""Iteration243: publish KV reuse directly from PV completion.

Based on v197, add a Tensor Core completion commit to the current KV
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        if (warp >= 8) & (warp < 12):
            ...
            for block in cutlass.range(num_blocks):
                ...
                tmem_after_sync()
                # Keep the original post-PV fences for this release-only control.
                tmem_before_sync()
