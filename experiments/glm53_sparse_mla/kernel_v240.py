"""Iteration240: keep separate register budgets inside actual role branches.

Based on v239, move producer104 and issuer/idle56 register decreases into
complete-warpgroup role branches. Compute176 and all loops, arithmetic,
layouts and barriers are unchanged. Avoid reconverging different donor
budgets before entering the producer code.
"""
import math
import os
import torch
