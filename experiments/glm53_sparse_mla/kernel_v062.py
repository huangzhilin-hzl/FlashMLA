"""Iteration 062: register-specialized persistent CTAs; based on iteration054; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v062 requires --block-k 128"
