"""Iteration238: producer unroll2 with96/160 role registers.

Based onv237,raise donor/producer allocation from80 to96 andlower
compute176 to160. This uses the existing65536-register CTA pool to investigate
producer spills caused byunrolling; all loop,math andbarrier behavior stays fixed.
"""
import math
import os
import torch
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # Initial128*512=65536; final256*96+256*160=65536 registers.
        if warp >= 8:
