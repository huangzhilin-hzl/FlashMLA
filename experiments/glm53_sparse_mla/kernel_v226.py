"""Iteration 226: publish vector-copy stages after producer completion; based on v224.
...
class SparseMLA:
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        # Inspect the initial register pool before launch; default compiler is4.6.2.
        if warp >= 8:
