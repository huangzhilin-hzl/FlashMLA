...
def mma_ws(d, a, b, n, b_transpose, accumulate, *, loc=None, ip=None):
    adesc = smem_descriptor_to_int(tcgen05.make_umma_smem_desc(
        a.iterator, a.layout, OperandMajorMode.K._to_ir(), loc=loc, ip=ip), loc=loc, ip=ip)
