...
/opt/sglang/bin/python bench.py \
  --kernel-version v284 --block-k 128 \
...
| v272, independent-role persistent query loops | Full bitwise equality to v190 on both seeds, short case and masks | Earlier fast path |
| v278, compute-role final TMEM release | Full bitwise equality to v272 on both seeds, short case and masks | Earlier fast path |
| v284, next Q overlaps the prior output epilogue | Full bitwise equality to v278 on both seeds, short case and masks | Current fast path |
...
It is a validated experimental alternative; v284 is now the established fast default.
...
The preceding experimental defaults were **v190 (fast)** and **v191 (higher precision)**; the fast default is now v284 after the persistence audit below.
...
across unmeasured inputs or clocks. Fast default is now **v284** after the persistence audit below.
...
## Earlier fast path: persistent independent-role query loops
...
## Earlier strict path: persistent high/residual probabilities

v273 applies the independent-role148-CTA schedule to v197 while preserving its
high/residual arithmetic, collector order and donor64/compute176 limits. It
passes guarded fixed/variable-length and odd-batch checks, and matches v197
bitwise on both full seeds, the full short case and masked inputs. This preserves
the strict parent's complete original-tolerance passes on those audited fixtures.

Five endpoint-OFF Graph orders give warm1825.040–1832.480 us and
cold1792.224–1794.288 us, beating paired v197 in all10 comparisons by approximately
0.9%–2.3%. Original20/100 eager warm/cold is1783.776/1792.208 us versus
TRT1871.600/1915.456 us; Graph is1847.392/1800.352 us versus1865.872/1900.592 us.
The warm advantage over TRT remains sensitive to operating conditions. Like v272,
v273 uses an8-byte scalar metadata stack with measured local requests; the
complete measured latency includes that cost. Compiler remains CuTeDSL4.6.2.


## Earlier defaults: v278 fast and v281 strict

v278 moves the final warp0 TMEM release inside the compute-role branch of v272.
It retains the8-byte scalar query-state frame but cuts measured local-read sectors
from1711424 to892432. The warm/cold five-round endpoint-OFF audit favors v278 in all
ten pairs, mostly by less than1%. Original20/100 eager warm/cold is1585.936/1599.776 us
versus paired TRT1872.000/1915.168 us; Graph1599.632/1592.960 us versus1869.216/1919.136 us.
The matching v272 audits give1596.544/1601.552 and1611.120/1597.344 us respectively.

v281 applies compute-local release and separate role-entry CTA-index reads to v273.
It haszero stack andzero measured local traffic. The strict five-round audit favors
it over intermediate v279 in all ten pairs and over v273 in nine, with one small warm
regression. Original20/100 eager warm/cold is1765.760/1790.032 us versus paired
TRT1879.968/1916.416 us; Graph1846.816/1801.616 us versus1865.792/1915.808 us.
Matching v273 audits give1782.784/1800.224 and1858.560/1808.096 us respectively.
Warm margins remain operating-condition dependent; this is a small incremental gain.

Both defaults pass guarded memory and fixed/variable/odd-batch synchronization checks.
Both full seeds, the full short case and masks are bitwise equal to their promoted
predecessors, preserving fast FP8 failures and strict audited tolerance passes.
Compiler remains CuTeDSL4.6.2. v279/v280 are retained as validated controls;
...
advance during the old query's epilogue. P-ready still prevents next PV from
reusing O before the compute epilogue finishes. No extra Q buffer, extra input
conversion or change in mathematical order is introduced. Each Q is loaded once.

Both paths pass guarded memory and fixed/variable/odd-batch synchronization checks,
and full bitwise equivalence to278/281 on two full seeds, the full short case and
masks. Fast precision limits and strict audited tolerance passes remain unchanged.
Both beat their parents in all ten endpoint-OFF rotating warm/cold Graph pairs;
fast parent/candidate ranges1.020615–1.038201, strict1.004463–1.016638.

Original20/100 eager fast warm/cold is1537.808/1552.432 us versus paired
TRT1882.032/1921.312 us; Graph1569.232/1554.384 versus1865.808/1916.864 us.
Strict eager is1756.320/1755.280 us versus1869.888/1916.960 us;
Graph1817.184/1771.280 versus1858.592/1911.936 us. Each condition also improves
its matching parent audit. These are measured results under unlocked clocks,
not guarantees for every input or execution regime. Fast retains its8-byte scalar
frame; strict retainszero stack/local traffic. Compiler remains CuTeDSL4.6.2.


A separately validated two-event probe records consecutive queries in the same CTA.
Over24132 pairs per version, median next-first-QK submission-entry delay after old compute-epilogue
completion falls from1504/1536 ns in278/281 to448 ns in284/285. Only22 fast pairs
andzero strict pairs enter next-QK submission before the old epilogue ends. This supports a
shorter query-transition gap rather than claiming pervasive QK/output overlap.
The probe's timestamps have observed32 ns granularity; it passes memory,
fixed/variable/odd-batch synchronization and three full output-equivalence repeats.
Its extra stores/control can perturb scheduling, so these are event-order observations,
not production latency measurements or a decomposition of time saved.
