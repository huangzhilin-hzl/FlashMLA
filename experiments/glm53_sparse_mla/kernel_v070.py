"""Iteration 070: single-P bounded-anchor accuracy/performance experiment; based on054; weight-stationary MMA with one-head TMEM loads and deferred sums.
...
class SparseMLA:
    def __init__(self, block_k=128):
        assert block_k == 128, "v070 requires --block-k 128"
    ...
    def kernel(self, q: cute.Tensor, kv: cute.Tensor, idx: cute.Tensor,
        ...
        if tid >= 256:
            ...
            for block in cutlass.range(num_blocks):
                ...
                # Same finite-range bound as residual v067, without its correction term.
                # This changes probability quantization and needs a fresh accuracy audit.
