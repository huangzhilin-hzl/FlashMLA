...
compiler_prefix="$experiment_dir/compiler_envs/cutlass463"
...
for package in ("nvidia-cutlass-dsl", "nvidia-cutlass-dsl-libs-base",
    ...
    assert metadata.version(package) == "4.6.3", (package, metadata.version(package))
assert cutlass.__version__ == "4.6.3", cutlass.__version__
