...
import shutil
base=Path('artifacts/producer_unroll_balanced_compile')
snap=Path('artifacts/snapshots/producer_unroll_balanced_compile')
...
shutil.copy2('artifacts/v241_compile_preflight.log',snap/'preflight.log')
