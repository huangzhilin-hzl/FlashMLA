...
/opt/sglang/bin/python check_gpu_idle.py > artifacts/producer_unroll_compile_preflight.log 2>&1
for version in v235 v236; do
 mkdir -p "artifacts/producer_unroll_compile/$version"
 (
  cd "artifacts/producer_unroll_compile/$version"
