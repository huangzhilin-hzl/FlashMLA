...
Record first-QK issue and compute-epilogue completion in separate instrumented
copies. No added CTA barrier or shared-memory allocation. Global timestamp
