"""Iteration 281: role-local CTA index read; based on v279.
...
def role_cta_id(*, loc=None, ip=None):
    return cutlass.Int32(llvm.inline_asm(cutlass.Int32.mlir_type, [], 'mov.u32 $0, %ctaid.x;', '=r', has_side_effects=True, is_align_stack=False, asm_dialect=llvm.AsmDialect.AD_ATT, loc=loc, ip=ip))
...
class SparseMLA:
    ...
    def __init__(self, block_k=128):
        assert block_k == 128, 'v281 requires --block-k 128'
