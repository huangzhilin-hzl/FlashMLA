"""Iteration255: pipeline private sparse-index reads during prior gathers.

Based on qualified fast default v190. Load the next iteration's private
index before issuing current-stage TMA gathers, retaining it across that
producer work. Shared publications, barriers and arithmetic stay intact.
"""
import math
import os
import torch
