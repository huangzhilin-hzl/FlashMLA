...
/opt/sglang/bin/python check_gpu_idle.py > artifacts/compute_full_acquire_compile_preflight.log 2>&1
for version in v248 v249; do
 mkdir -p "artifacts/compute_full_acquire_compile/$version"
 (
  cd "artifacts/compute_full_acquire_compile/$version"
