...
/opt/sglang/bin/python check_gpu_idle.py > artifacts/single_pv_completion_compile_preflight.log 2>&1
for version in v246 v247; do
 mkdir -p "artifacts/single_pv_completion_compile/$version"
 (
  cd "artifacts/single_pv_completion_compile/$version"
