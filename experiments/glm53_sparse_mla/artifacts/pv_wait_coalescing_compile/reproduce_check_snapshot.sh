...
base=Path('artifacts/pv_wait_coalescing_compile')
expected={'v244':('32fd0ad55dc9afd398211f5cf75449903110195c84680889d13b1f6d5b4a6f1e',118),'v245':('0cc7508ae673181fe34e728fad44e3b4c2f3e14c1d24216b69047232562a72ec',128)}
summary={}
...
snap=Path('artifacts/snapshots/pv_wait_coalescing_compile');assert not snap.exists()
for p in base.rglob('*'):
...
shutil.copy2('artifacts/pv_wait_coalescing_compile_preflight.log',snap/'preflight.log')
PY
