...
/opt/sglang/bin/python check_gpu_idle.py > artifacts/pv_wait_coalescing_compile_preflight.log 2>&1
for version in v244 v245; do
 mkdir -p "artifacts/pv_wait_coalescing_compile/$version"
 (
  cd "artifacts/pv_wait_coalescing_compile/$version"
