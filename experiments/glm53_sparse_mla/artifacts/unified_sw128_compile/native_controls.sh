...
root=Path('artifacts/unified_sw128_compile');out={}
for version,parent,parent_folder in [('v296','v284','query_epilogue_overlap_compile'),('v297','v287','query_pv_overlap_compile')]:
 ...
 assert re.search(r'setmaxnreg\.inc\.sync\.aligned\.u32\s+'+('192' if version=='v296' else '176')+';',ptx)
